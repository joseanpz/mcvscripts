...
select
case
    when "Moneda" in ('DOLARE', 'DOLAR') then lpad(concat("Linea Original", '02'::char(2)), 20, '0'::char(1))::char(20)
    else lpad(concat("Linea Original", '01'::char(2)), 20, '0'::char(1))::char(20)
