...
RETURN QUERY SELECT
	...
	CASE
		WHEN (FLOOR(T2."FECHA"/100) - FLOOR(T1."FECHA"/100))*12 + MOD(T2."FECHA",100) - MOD(T1."FECHA",100) NOT BETWEEN 0 AND months THEN NULL::INTEGER
...
WHERE
	...
	AND T1."FECHA" BETWEEN initial_month AND final_month
...
-- GROUP BY T1."LLAVE_UNIVERSAL", T1."FECHA", T1."SALDO", T1."CARTERA_VENCIDA";
