...
SELECT    
    ...
    CASE 
        ...
        WHEN B.UEN NOT IN ('05 PEQUEÑA EMPRESA NL', '09 PEQUEÑA EMPRESA TERRITORIAL') 
            OR B.PERFIL_NEGOCIO_ACTUAL IN ('CORPORATIVO', 'DIRECCION', 'DUMMY', 'GOBIERNO')
            OR B.PRODUCTO IN ('3I ACS AUTOPRESTO', '3N ACS AUTOPRESTO', 'Z1 SEGURO ACS AUTOPRESTO')
            OR B.SUBSEGMENTO_PRODUCTO = 'AB - VARIOS' THEN 0 
        ELSE NULL
    END AS UEN_PEQ
