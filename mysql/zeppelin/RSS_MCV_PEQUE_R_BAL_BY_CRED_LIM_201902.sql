%hive
DROP TABLE IF EXISTS RSS_MCV_PEQUE_R_BAL_BY_CRED_LIM_201902;

CREATE TABLE  RSS_MCV_PEQUE_R_BAL_BY_CRED_LIM_201902
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS_MCV_PEQUE_R_BAL_BY_CRED_LIM_201902' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,
