%hive
DROP TABLE IF EXISTS RSS_MCV_PEQUE_VAR_CR_RESUMEN_201902;

CREATE TABLE  RSS_MCV_PEQUE_VAR_CR_RESUMEN_201902
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS_MCV_PEQUE_VAR_CR_RESUMEN_201902' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_PEQUE_VAR_CR_RESUMEN_201902 
SELECT
a.fecha , 
a.rfc,
b.num_op_acc,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_CR_RESUMEN_201902 b
