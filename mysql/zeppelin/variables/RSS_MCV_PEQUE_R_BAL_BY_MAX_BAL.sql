%hive
DROP TABLE IF EXISTS RSS_MCV_PEQUE_R_BAL_BY_MAX_BAL;

CREATE TABLE  RSS_MCV_PEQUE_R_BAL_BY_MAX_BAL
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS_MCV_PEQUE_R_BAL_BY_MAX_BAL' AS
SELECT
'fecha' AS fecha,
'rfc' AS rfc,
...
INSERT INTO RSS_MCV_PEQUE_R_BAL_BY_MAX_BAL
