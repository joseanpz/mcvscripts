...
DROP TABLE IF EXISTS JEA_MCV_UNIVERSO_CVLABEL_COMERCIAL;

CREATE TABLE IF NOT EXISTS
JEA_MCV_UNIVERSO_CVLABEL_COMERCIAL
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/JEA_MCV_UNIVERSO_CVLABEL_COMERCIAL' AS
