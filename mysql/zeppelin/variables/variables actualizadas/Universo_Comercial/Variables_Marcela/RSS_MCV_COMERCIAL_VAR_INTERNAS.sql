%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VAR_INTERNAS;

CREATE TABLE  RSS_MCV_COMERCIAL_VAR_INTERNAS
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VAR_INTERNAS' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,   
...
INSERT INTO RSS_MCV_COMERCIAL_VAR_INTERNAS
SELECT 
a.fecha,
a.rfc , 
b.util_interna_t00,
