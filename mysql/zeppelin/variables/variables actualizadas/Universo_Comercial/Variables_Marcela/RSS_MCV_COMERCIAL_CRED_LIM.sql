%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_CRED_LIM;

CREATE TABLE  RSS_MCV_COMERCIAL_CRED_LIM
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_CRED_LIM' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_COMERCIAL_CRED_LIM 
SELECT
distinct
a.fecha,
a.rfc ,
