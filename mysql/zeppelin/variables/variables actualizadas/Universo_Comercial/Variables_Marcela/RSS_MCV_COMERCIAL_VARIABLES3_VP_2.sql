%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VARIABLES3_VP_2;

CREATE TABLE  RSS_MCV_COMERCIAL_VARIABLES3_VP_2
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VARIABLES3_VP_2' AS
SELECT  
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_COMERCIAL_VARIABLES3_VP_2
SELECT 
a.fecha,
a.rfc , 
