%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VARIABLES2_VP;

CREATE TABLE  RSS_MCV_COMERCIAL_VARIABLES2_VP
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VARIABLES2_VP' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_COMERCIAL_VARIABLES2_VP
SELECT
a.fecha,
a.rfc , 
...
LEFT JOIN dbriskdatamart.JAT_MCV_VARIABLES2_VP_201907 b
