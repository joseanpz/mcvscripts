%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VAR_PEDRO;

CREATE TABLE  RSS_MCV_COMERCIAL_VAR_PEDRO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VAR_PEDRO' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_COMERCIAL_VAR_PEDRO
SELECT distinct 
a.fecha,
a.rfc,
b.pct_dbt_bk,
