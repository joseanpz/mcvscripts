%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_R_BAL_BY_CRED_LIM;

CREATE TABLE  RSS_MCV_COMERCIAL_R_BAL_BY_CRED_LIM
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_R_BAL_BY_CRED_LIM' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,
...
insert into RSS_MCV_COMERCIAL_R_BAL_BY_CRED_LIM
select distinct
a.fecha,
a.rfc ,
b.r_bal_by_cred_lim,
