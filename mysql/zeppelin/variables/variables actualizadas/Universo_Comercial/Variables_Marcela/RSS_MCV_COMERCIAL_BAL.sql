%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_BAL;

CREATE TABLE  RSS_MCV_COMERCIAL_BAL
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_BAL' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
'cur_bal' AS cur_bal,
...
INSERT INTO RSS_MCV_COMERCIAL_BAL
SELECT distinct
a.fecha,
a.rfc ,
b.cur_bal,
