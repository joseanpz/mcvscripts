%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VAR_HI;

CREATE TABLE  RSS_MCV_COMERCIAL_VAR_HI
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 

LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VAR_HI' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,  
...
INSERT INTO RSS_MCV_COMERCIAL_VAR_HI
SELECT 
a.fecha,
a.rfc ,
b.max_venc29_03m,
