%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_D_CRED_LIM_TO_BAL;

CREATE TABLE  RSS_MCV_COMERCIAL_D_CRED_LIM_TO_BAL
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_D_CRED_LIM_TO_BAL' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO RSS_MCV_COMERCIAL_D_CRED_LIM_TO_BAL
SELECT distinct
a.fecha,
a.rfc ,
b.d_cred_lim_to_bal,
