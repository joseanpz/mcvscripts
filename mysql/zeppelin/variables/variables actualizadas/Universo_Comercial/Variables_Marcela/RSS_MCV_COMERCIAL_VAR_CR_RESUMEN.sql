...
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_VAR_CR_RESUMEN;

CREATE TABLE  RSS_MCV_COMERCIAL_VAR_CR_RESUMEN
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_COMERCIAL_VAR_CR_RESUMEN' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_COMERCIAL_VAR_CR_RESUMEN 
SELECT
a.fecha , 
a.rfc,
b.num_op_acc,
