%hive
DROP TABLE IF EXISTS RSS_MCV_PREUNIVERSO_COMERCIAL;

CREATE TABLE IF NOT EXISTS RSS_MCV_PREUNIVERSO_COMERCIAL 
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 

LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_PREUNIVERSO_COMERCIAL' AS
...
INNER JOIN RSS_MCV_UNIVERSO_LLAVES_COMERCIAL B
...
LEFT JOIN (SELECT  distinct LLAVE_UNIVERSAL_20 from RSS_MCV_CATALOGO_LIN_NAC_VENC_COMERCIAL ) D
