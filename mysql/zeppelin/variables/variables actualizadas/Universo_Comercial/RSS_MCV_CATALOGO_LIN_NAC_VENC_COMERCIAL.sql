%hive
DROP TABLE IF EXISTS RSS_MCV_CATALOGO_LIN_NAC_VENC_COMERCIAL;

CREATE TABLE IF NOT EXISTS RSS_MCV_CATALOGO_LIN_NAC_VENC_COMERCIAL 
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_CATALOGO_LIN_NAC_VENC_COMERCIAL' AS
...
(
    ...
    WHERE LLAVE_UNIVERSAL_20 IN (
        SELECT DISTINCT 
        LLAVE_UNIVERSAL
         FROM RSS_MCV_UNIVERSO_LLAVES_COMERCIAL
