...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Diciembre/Variables/RSS_MCV_NEGOCIOS_VARIABLES3_VP_2' AS
SELECT  
'fecha' AS fecha,
'rfc' as rfc , 
...
LEFT JOIN dbmymwork.JAT_MCV_VARIABLES3_VP_201912 b
