%hive
DROP TABLE IF EXISTS JEA_MCV_UNIVERSO_CVLABEL_NEGOCIOS;

-- CREATE TABLE IF NOT EXISTS
JEA_MCV_UNIVERSO_CVLABEL_NEGOCIOS
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Septiembre/Universo/JEA_MCV_UNIVERSO_CVLABEL_NEGOCIOS'AS
