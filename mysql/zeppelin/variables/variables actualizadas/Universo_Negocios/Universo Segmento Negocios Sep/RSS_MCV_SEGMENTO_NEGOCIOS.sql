...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Septiembre/Universo/RSS_MCV_SEGMENTO_NEGOCIOS' AS
...
LEFT JOIN (
	...
	FROM dbriskdatamart.MZM_MCV_UNIVERSO_MODELADO_201909
	GROUP BY fecha , rfc 
) C
ON B.FECHA = C.fecha and B.RFC = C.rfc
where B.fecha = '201909' 
