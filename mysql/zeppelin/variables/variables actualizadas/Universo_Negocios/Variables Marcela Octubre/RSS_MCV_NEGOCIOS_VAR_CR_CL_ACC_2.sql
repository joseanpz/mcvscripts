...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Variables/RSS_MCV_NEGOCIOS_VAR_CR_CL_ACC_2' AS
SELECT  
'fecha' AS fecha,
'rfc' as rfc ,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_CR_CL_ACC_2_201910 b
