...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Variables/RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL' AS
SELECT
'fecha' AS fecha,
'rfc' AS rfc,
...
LEFT JOIN dbriskdatamart.MZM_MCV_R_BAL_BY_MAX_BAL_201910 b
