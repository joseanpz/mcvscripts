...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Variables/RSS_MCV_NEGOCIOS_BURO_CAL_PM' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
'12_inst' AS 12_inst,
...
LEFT JOIN dbriskdatamart.MZM_MCV_BURO_CAL_PM_201910 b
