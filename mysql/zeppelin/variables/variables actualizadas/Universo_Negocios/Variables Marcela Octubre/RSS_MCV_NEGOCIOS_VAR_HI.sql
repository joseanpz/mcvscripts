...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Variables/RSS_MCV_NEGOCIOS_VAR_HI' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,  
...
LEFT JOIN dbriskdatamart.JAT_MCV_VAR_HI_201910 b
