...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Variables/RSS_MCV_NEGOCIOS_VARIABLES2_VP' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
LEFT JOIN dbmymwork.JAT_MCV_VARIABLES2_VP_201910 b
