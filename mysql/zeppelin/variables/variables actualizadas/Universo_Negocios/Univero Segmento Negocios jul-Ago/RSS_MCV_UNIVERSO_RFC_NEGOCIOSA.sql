%hive
DROP TABLE IF EXISTS RSS_MCV_UNIVERSO_RFC_NEGOCIOSA;

CREATE TABLE IF NOT EXISTS
RSS_MCV_UNIVERSO_RFC_NEGOCIOSA
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_UNIVERSO_RFC_NEGOCIOSA' AS
SELECT
  A.RFC,
  A.FECHA,
  A.MESESDC,
  ...
  CASE 
    ...
    ELSE 3
  END AS MONTO_CLS  
FROM  RSS_MCV_UNIVERSO_NEGOCIOSA A
