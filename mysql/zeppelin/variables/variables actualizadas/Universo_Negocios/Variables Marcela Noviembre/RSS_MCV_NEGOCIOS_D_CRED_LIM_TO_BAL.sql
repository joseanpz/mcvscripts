...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Noviembre/Variables/RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
LEFT JOIN dbriskdatamart.MZM_MCV_D_CRED_LIM_TO_BAL_201911 b
