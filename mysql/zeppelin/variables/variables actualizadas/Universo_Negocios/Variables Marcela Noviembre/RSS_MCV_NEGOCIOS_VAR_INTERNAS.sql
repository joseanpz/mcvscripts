...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Noviembre/Variables/RSS_MCV_NEGOCIOS_VAR_INTERNAS' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,   
...
LEFT JOIN dbriskdatamart.JAT_MCV_VAR_INTERNAS_201911 b
