...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Octubre/Universo/RSS_MCV_SEGMENTO_NEGOCIOS' AS
...
LEFT JOIN (
	...
	FROM dbriskdatamart.MZM_MCV_UNIVERSO_MODELADO_201910
	GROUP BY fecha , rfc 
) C
