%hive
DROP TABLE IF EXISTS RSS_MCV_UNIVERSO;

CREATE TABLE IF NOT EXISTS
RSS_MCV_UNIVERSO 
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_UNIVERSO' AS
SELECT
  A.RFC,  
...
LEFT JOIN dbriskdatamart.MZM_MCV_UNIVERSO_MODELADO_201906 D
