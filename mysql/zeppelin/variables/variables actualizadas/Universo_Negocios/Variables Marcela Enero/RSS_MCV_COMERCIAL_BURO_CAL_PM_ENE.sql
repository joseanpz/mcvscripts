%hive
DROP TABLE IF EXISTS RSS_MCV_COMERCIAL_BURO_CAL_PM_ENE;

CREATE TABLE  RSS_MCV_COMERCIAL_BURO_CAL_PM_ENE
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Enero/RSS_MCV_COMERCIAL_BURO_CAL_PM_ENE' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
'12_inst' AS 12_inst,
...
INSERT INTO RSS_MCV_COMERCIAL_BURO_CAL_PM_ENE
SELECT 
a.fecha,
a.rfc ,
b.12_inst,
...
LEFT JOIN dbriskdatamart.MZM_MCV_BURO_CAL_PM_201907 b
