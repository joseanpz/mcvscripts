%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_INTERNAS_ENE;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_INTERNAS_ENE
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/ENERO/RSS_MCV_NEGOCIOS_VAR_INTERNAS_ENE' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,   
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_INTERNAS_ENE
SELECT 
a.fecha,
a.rfc , 
b.util_interna_t00,
