%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_ENE;

CREATE TABLE  RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_ENE
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Enero/RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_ENE' AS
SELECT  
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_ENE
SELECT 
a.fecha,
a.rfc , 
