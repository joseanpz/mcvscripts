...
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_ENE;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_ENE
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Enero/RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_ENE' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_ENE
SELECT
a.fecha , 
a.rfc,
b.num_op_acc,
