%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_CRED_LIM_ENE;

CREATE TABLE  RSS_MCV_NEGOCIOS_CRED_LIM_ENE
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Enero/RSS_MCV_NEGOCIOS_CRED_LIM_ENE' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_CRED_LIM_ENE 
SELECT
distinct
a.fecha,
a.rfc ,
