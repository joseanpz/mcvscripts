...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Noviembre/Universo/RSS_MCV_SEGMENTO_NEGOCIOS' AS
...
LEFT JOIN (
	...
	FROM dbriskdatamart.MZM_MCV_UNIVERSO_MODELADO_201911
	GROUP BY fecha , rfc 
) C
