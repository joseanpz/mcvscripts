...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Noviembre/Universo/RSS_MCV_UNIVERSO_NEGOCIOS' AS
SELECT
  A.RFC,  
...
LEFT JOIN dbriskdatamart.MZM_MCV_UNIVERSO_MODELADO_201911 D
