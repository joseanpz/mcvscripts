%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_MAR;

CREATE TABLE  RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_MAR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Marzo/RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_MAR' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,
...
insert into RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_MAR
select distinct
a.fecha,
a.rfc ,
b.r_bal_by_cred_lim,
