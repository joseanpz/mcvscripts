%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_BURO_CAL_PM_MAR;

CREATE TABLE  RSS_MCV_NEGOCIOS_BURO_CAL_PM_MAR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Marzo/RSS_MCV_NEGOCIOS_BURO_CAL_PM_MAR' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
'12_inst' AS 12_inst,
...
INSERT INTO RSS_MCV_NEGOCIOS_BURO_CAL_PM_MAR
SELECT 
a.fecha,
a.rfc ,
b.12_inst,
