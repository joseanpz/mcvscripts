%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_MAR;

CREATE TABLE  RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_MAR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Marzo/RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_MAR' AS
SELECT
'fecha' AS fecha,
'rfc' AS rfc,
...
INSERT INTO RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_MAR
