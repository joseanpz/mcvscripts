%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_BAL_MAR;

CREATE TABLE  RSS_MCV_NEGOCIOS_BAL_MAR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Marzo/RSS_MCV_NEGOCIOS_BAL_MAR' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
'cur_bal' AS cur_bal,
...
INSERT INTO RSS_MCV_NEGOCIOS_BAL_MAR
SELECT distinct
a.fecha,
a.rfc ,
b.cur_bal,
