...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Septiembre/Variables/RSS_MCV_NEGOCIOS_VAR_MOVIMIENTOS_LINEA' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,     
...
LEFT JOIN dbriskdatamart.JAT_MCV_VAR_MOVIMIENTOS_LINEA_201909 b
