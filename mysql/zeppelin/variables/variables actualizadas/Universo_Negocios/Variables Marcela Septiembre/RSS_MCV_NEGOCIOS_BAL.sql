...
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Septiembre/Variables/RSS_MCV_NEGOCIOS_BAL' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
'cur_bal' AS cur_bal,
...
LEFT JOIN dbriskdatamart.MZM_MCV_BAL_201909 b
