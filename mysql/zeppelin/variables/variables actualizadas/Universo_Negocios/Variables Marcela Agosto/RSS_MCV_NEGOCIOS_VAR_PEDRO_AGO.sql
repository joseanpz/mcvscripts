%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_PEDRO_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_PEDRO_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_VAR_PEDRO_AGO' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_PEDRO_AGO
SELECT distinct 
a.fecha,
a.rfc,
b.pct_dbt_bk,
...
LEFT JOIN dbriskdatamart.JAT_MCV_VAR_PEDRO_201908 b
