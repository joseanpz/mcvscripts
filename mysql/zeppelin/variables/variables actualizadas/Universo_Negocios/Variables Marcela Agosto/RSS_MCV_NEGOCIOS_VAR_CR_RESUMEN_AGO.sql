...
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_AGO' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_AGO
SELECT
a.fecha , 
a.rfc,
b.num_op_acc,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_CR_RESUMEN_201908 b
