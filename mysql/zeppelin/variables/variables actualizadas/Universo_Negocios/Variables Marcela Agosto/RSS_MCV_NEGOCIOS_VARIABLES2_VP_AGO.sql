%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VARIABLES2_VP_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_VARIABLES2_VP_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_VARIABLES2_VP_AGO' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VARIABLES2_VP_AGO
SELECT
a.fecha,
a.rfc , 
...
LEFT JOIN dbmymwork.JAT_MCV_VARIABLES2_VP_201908 b
