%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_CRED_LIM_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_CRED_LIM_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_CRED_LIM_AGO' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_CRED_LIM_AGO 
SELECT
distinct
a.fecha,
a.rfc ,
...
LEFT JOIN dbriskdatamart.MZM_MCV_CRED_LIM_201908 b
