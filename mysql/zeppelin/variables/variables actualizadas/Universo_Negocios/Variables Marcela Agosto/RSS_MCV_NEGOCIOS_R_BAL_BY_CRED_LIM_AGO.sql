%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_AGO' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,
...
insert into RSS_MCV_NEGOCIOS_R_BAL_BY_CRED_LIM_AGO
select distinct
a.fecha,
a.rfc ,
b.r_bal_by_cred_lim,
...
LEFT JOIN dbriskdatamart.MZM_MCV_R_BAL_BY_CRED_LIM_201908 b
