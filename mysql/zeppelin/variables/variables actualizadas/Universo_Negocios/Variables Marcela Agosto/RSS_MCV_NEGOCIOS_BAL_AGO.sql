%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_BAL_AGO;

CREATE TABLE  RSS_MCV_NEGOCIOS_BAL_AGO
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Agosto/RSS_MCV_NEGOCIOS_BAL_AGO' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
'cur_bal' AS cur_bal,
...
INSERT INTO RSS_MCV_NEGOCIOS_BAL_AGO
SELECT distinct
a.fecha,
a.rfc ,
b.cur_bal,
...
LEFT JOIN dbriskdatamart.MZM_MCV_BAL_201908 b
