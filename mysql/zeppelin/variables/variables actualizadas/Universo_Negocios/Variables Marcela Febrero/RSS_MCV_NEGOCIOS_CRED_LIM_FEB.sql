%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_CRED_LIM_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_CRED_LIM_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_CRED_LIM_FEB' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_CRED_LIM_FEB 
SELECT
distinct
a.fecha,
a.rfc ,
...
LEFT JOIN dbriskdatamart.MZM_MCV_CRED_LIM_201907 b
