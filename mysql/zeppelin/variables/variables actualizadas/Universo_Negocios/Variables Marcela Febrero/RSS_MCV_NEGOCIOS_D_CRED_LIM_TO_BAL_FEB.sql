%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_FEB' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_FEB
SELECT distinct
a.fecha,
a.rfc ,
b.d_cred_lim_to_bal,
...
LEFT JOIN dbriskdatamart.MZM_MCV_D_CRED_LIM_TO_BAL_201907 b
