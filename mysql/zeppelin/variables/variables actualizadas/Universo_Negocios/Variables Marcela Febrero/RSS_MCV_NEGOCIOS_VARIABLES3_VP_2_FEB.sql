%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_FEB' AS
SELECT  
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VARIABLES3_VP_2_FEB
SELECT 
a.fecha,
a.rfc , 
