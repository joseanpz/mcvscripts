%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_FEB' AS
SELECT
'fecha' AS fecha,
'rfc' AS rfc,
...
INSERT INTO RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_FEB
...
LEFT JOIN dbriskdatamart.MZM_MCV_R_BAL_BY_MAX_BAL_201907 b
