%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_FEB' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_FEB
select
a.fecha,
a.rfc ,  
b.ms_desde_atr01m,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_VARIABLES_DIASATRASO2_201907 b
