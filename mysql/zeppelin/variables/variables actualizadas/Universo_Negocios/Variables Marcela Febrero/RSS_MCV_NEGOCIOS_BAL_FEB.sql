%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_BAL_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_BAL_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_BAL_FEB' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
'cur_bal' AS cur_bal,
...
INSERT INTO RSS_MCV_NEGOCIOS_BAL_FEB
SELECT distinct
a.fecha,
a.rfc ,
b.cur_bal,
...
LEFT JOIN dbriskdatamart.MZM_MCV_BAL_201907 b
