%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_HI_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_HI_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 

LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_VAR_HI_FEB' AS
SELECT
'fecha' AS fecha,
'rfc' as rfc ,  
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_HI_FEB
SELECT 
a.fecha,
a.rfc ,
b.max_venc29_03m,
...
LEFT JOIN dbriskdatamart.JAT_MCV_VAR_HI_201907 b
