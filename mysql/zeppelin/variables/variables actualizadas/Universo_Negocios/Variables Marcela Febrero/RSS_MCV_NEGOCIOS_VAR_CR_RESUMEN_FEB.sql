...
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_FEB;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_FEB
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Febrero/RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_FEB' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO  RSS_MCV_NEGOCIOS_VAR_CR_RESUMEN_FEB
SELECT
a.fecha , 
a.rfc,
b.num_op_acc,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_CR_RESUMEN_201907 b
