%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_ABR;

CREATE TABLE  RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_ABR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Abril/RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_ABR' AS
SELECT
'fecha' AS fecha,
'rfc' AS rfc,
...
INSERT INTO RSS_MCV_NEGOCIOS_R_BAL_BY_MAX_BAL_ABR
