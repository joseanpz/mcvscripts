%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_INTERNAS_ABR;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_INTERNAS_ABR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Abril/RSS_MCV_NEGOCIOS_VAR_INTERNAS_ABR' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,   
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_INTERNAS_ABR
SELECT 
a.fecha,
a.rfc , 
b.util_interna_t00,
