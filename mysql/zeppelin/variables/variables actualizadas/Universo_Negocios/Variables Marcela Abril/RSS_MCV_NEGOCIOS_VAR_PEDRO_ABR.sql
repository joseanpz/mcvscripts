%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_PEDRO_ABR;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_PEDRO_ABR
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/Abril/RSS_MCV_NEGOCIOS_VAR_PEDRO_ABR' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_PEDRO_ABR
SELECT distinct 
a.fecha,
a.rfc,
b.pct_dbt_bk,
