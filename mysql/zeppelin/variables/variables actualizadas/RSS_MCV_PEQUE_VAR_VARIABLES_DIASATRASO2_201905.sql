%hive
DROP TABLE IF EXISTS RSS_MCV_PEQUE_VAR_VARIABLES_DIASATRASO2_201905;

CREATE TABLE  RSS_MCV_PEQUE_VAR_VARIABLES_DIASATRASO2_201905
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS_MCV_PEQUE_VAR_VARIABLES_DIASATRASO2_201905' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_PEQUE_VAR_VARIABLES_DIASATRASO2_201905
select
a.fecha,
a.rfc ,  
b.ms_desde_atr01m,
...
LEFT JOIN dbriskdatamart.MZM_MCV_VAR_VARIABLES_DIASATRASO2_201905 b
