%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_BURO_CAL_PM_HIST;

CREATE TABLE  RSS_MCV_NEGOCIOS_BURO_CAL_PM_HIST
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_NEGOCIOS_BURO_CAL_PM_HIST' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc ,
'12_inst' AS 12_inst,
...
INSERT INTO RSS_MCV_NEGOCIOS_BURO_CAL_PM_HIST
SELECT 
a.fecha,
a.rfc ,
b.12_inst,
