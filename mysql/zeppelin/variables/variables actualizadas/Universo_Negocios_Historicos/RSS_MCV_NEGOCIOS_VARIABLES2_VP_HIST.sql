%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VARIABLES2_VP_HIST;

CREATE TABLE  RSS_MCV_NEGOCIOS_VARIABLES2_VP_HIST
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_NEGOCIOS_VARIABLES2_VP_HIST' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VARIABLES2_VP_HIST
SELECT
a.fecha,
a.rfc , 
