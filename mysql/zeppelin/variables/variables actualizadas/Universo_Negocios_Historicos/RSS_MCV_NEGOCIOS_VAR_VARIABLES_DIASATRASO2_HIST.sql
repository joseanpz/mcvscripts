%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_HIST;

CREATE TABLE  RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_HIST
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_HIST' AS
SELECT 
'fecha' AS fecha,
'rfc' as rfc , 
...
INSERT INTO RSS_MCV_NEGOCIOS_VAR_VARIABLES_DIASATRASO2_HIST
select
a.fecha,
a.rfc ,  
b.ms_desde_atr01m,
