%hive
DROP TABLE IF EXISTS RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_HIST;

CREATE TABLE  RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_HIST
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS/RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_HIST' AS
SELECT   
'fecha' AS fecha,
'rfc' as rfc ,
...
INSERT INTO RSS_MCV_NEGOCIOS_D_CRED_LIM_TO_BAL_HIST
SELECT distinct
a.fecha,
a.rfc ,
b.d_cred_lim_to_bal,
