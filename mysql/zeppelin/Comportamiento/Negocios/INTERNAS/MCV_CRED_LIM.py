...
DROP TABLE IF EXISTS dbriskdatamart.MZM_MCV_CRED_LIM__${FECHA_CALIFICACION};
CREATE TABLE dbriskdatamart.MZM_MCV_CRED_LIM__${FECHA_CALIFICACION}
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'

LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MZM/MCV/MZM_MCV_CRED_LIM__${FECHA_CALIFICACION}' AS 
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MAX(T2.MONTO_LINEA) AS MAX_CRED_LIM_03M
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MIN(T2.MONTO_LINEA) AS MIN_CRED_LIM_03M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_03M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, AVG(T2.MONTO_LINEA) AS AVG_CRED_LIM_03M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_03M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    ...
    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MENOS_CRED_LIM_03M

    FROM 


        (SELECT T1.RFC, T1.FECHA, SUM(T2.MONTO_LINEA * ((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)+1)) AS PND_1
        										FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1
        										LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
        										ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
        									WHERE T2.FECHA >= T1.FECHA_TOPE_03M AND T2.FECHA <= T1.FECHA
        ...
        (SELECT T1.RFC, T1.FECHA, SUM((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)+1) AS PND_2
    									...
    									WHERE T2.FECHA >= T1.FECHA_TOPE_03M AND T2.FECHA <= T1.FECHA
    									GROUP BY T1.RFC,T1.FECHA) T2
    	ON T1.RFC=T2.RFC AND T1.FECHA = T2.FECHA						) T5
    ON T1.RFC=T5.RFC AND T1.FECHA=T5.FECHA

LEFT JOIN

    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MAS_CRED_LIM_03M

    FROM 


        (SELECT T1.RFC, T1.FECHA, SUM(T2.MONTO_LINEA * (4-((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)))) AS PND_1
        										FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1
        										LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
        										ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
        									WHERE T2.FECHA >= T1.FECHA_TOPE_03M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MAX(T2.MONTO_LINEA) AS MAX_CRED_LIM_06M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_06M AND T2.FECHA <= T1.FECHA
            GROUP BY T1.RFC,T1.FECHA) T7
    ON T1.RFC=T7.RFC AND T1.FECHA=T7.FECHA

LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MIN(T2.MONTO_LINEA) AS MIN_CRED_LIM_06M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_06M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, AVG(T2.MONTO_LINEA) AS AVG_CRED_LIM_06M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_06M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    ...
    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MENOS_CRED_LIM_06M
    ...
    FROM 
        ...
        (SELECT T1.RFC, T1.FECHA, SUM((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)+1) AS PND_2
    									...
    									WHERE T2.FECHA >= T1.FECHA_TOPE_06M AND T2.FECHA <= T1.FECHA
    									GROUP BY T1.RFC,T1.FECHA) T2
    	ON T1.RFC=T2.RFC AND T1.FECHA = T2.FECHA						) T10
    ON T1.RFC=T10.RFC AND T1.FECHA=T10.FECHA

LEFT JOIN

    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MAS_CRED_LIM_06M

    FROM 


        (SELECT T1.RFC, T1.FECHA, SUM(T2.MONTO_LINEA * (7-((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)))) AS PND_1
        										FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1
        										LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
        										ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
        									WHERE T2.FECHA >= T1.FECHA_TOPE_06M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MAX(T2.MONTO_LINEA) AS MAX_CRED_LIM_12M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_12M AND T2.FECHA <= T1.FECHA
            GROUP BY T1.RFC,T1.FECHA) T12
    ON T1.RFC=T12.RFC AND T1.FECHA=T12.FECHA

LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, MIN(T2.MONTO_LINEA) AS MIN_CRED_LIM_12M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_12M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    (SELECT T1.RFC, T1.FECHA, AVG(T2.MONTO_LINEA) AS AVG_CRED_LIM_12M
            FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1 
            LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
            ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
            WHERE T2.FECHA >= T1.FECHA_TOPE_12M AND T2.FECHA <= T1.FECHA
...
LEFT JOIN
    ...
    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MENOS_CRED_LIM_12M
    ...
    FROM 
        ...
        (SELECT T1.RFC, T1.FECHA, SUM((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)+1) AS PND_2
    									...
    									WHERE T2.FECHA >= T1.FECHA_TOPE_12M AND T2.FECHA <= T1.FECHA
    									GROUP BY T1.RFC,T1.FECHA) T2
    	ON T1.RFC=T2.RFC AND T1.FECHA = T2.FECHA						) T15
    ON T1.RFC=T15.RFC AND T1.FECHA=T15.FECHA

LEFT JOIN

    (SELECT T1.RFC, T1.FECHA , PND_1/PND_2 AS AVG_PND_MAS_CRED_LIM_12M

    FROM 


        (SELECT T1.RFC, T1.FECHA, SUM(T2.MONTO_LINEA * (13-((FLOOR(T1.FECHA/100)-FLOOR(T2.FECHA/100))*12+MOD(T1.FECHA,100)-MOD(T2.FECHA,100)))) AS PND_1
        										FROM dbriskdatamart.MZM_MCV_FECHAS__${FECHA_CALIFICACION} T1
        										LEFT JOIN dbriskdatamart.TBL_CARTERACREDITICIA T2
        										ON T1.RFC = T2.RFC AND T1.FECHA = T2.FECHA
        									WHERE T2.FECHA >= T1.FECHA_TOPE_12M AND T2.FECHA <= T1.FECHA
...
;
 ...
 SELECT * FROM dbriskdatamart.MZM_MCV_CRED_LIM__${FECHA_CALIFICACION} LIMIT 100;