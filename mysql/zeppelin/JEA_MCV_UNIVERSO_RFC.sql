%hive
DROP TABLE IF EXISTS JEA_MCV_UNIVERSO_RFC;

CREATE TABLE IF NOT EXISTS
JEA_MCV_UNIVERSO_RFC
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/JEA/dbmymwork/JEA_MCV_UNIVERSO_RFC' AS
SELECT
  A.RFC,
  A.FECHA,
  A.MESESDC,
