%hive
DROP TABLE IF EXISTS JEA_MCV_UNIVERSO_CVLABEL;

CREATE TABLE IF NOT EXISTS
JEA_MCV_UNIVERSO_CVLABEL
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/JEA/dbmymwork/JEA_MCV_UNIVERSO_CVLABEL' AS
