%hive
DROP TABLE IF EXISTS RSS_MCV_CATALOGO_LIN_NAC_VENC;

CREATE TABLE IF NOT EXISTS RSS_MCV_CATALOGO_LIN_NAC_VENC 
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|' 
LOCATION 's3://boi-banregio/datalake/data/InteligenciaRiesgos/M&M/MCV/RSS_MCV_CATALOGO_LIN_NAC_VENC' AS
