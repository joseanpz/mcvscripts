...
select
  ...
  sum(c.saldo * (1 + (a.mesesdc - c.mesesdc))) / sum(1 + (a.mesesdc - c.mesesdc))  as avg_pnd_menos_bal_03m,
  sum(c.saldo * (4 - (a.mesesdc - c.mesesdc))) / sum(4 - (a.mesesdc - c.mesesdc)) as avg_pnd_mas_bal_03m,
...
select
  ...
  sum(b.saldo * (1 + (a.mesesdc - b.mesesdc))) / sum(1 + (a.mesesdc - b.mesesdc))  as avg_pnd_menos_bal_06m,
  sum(b.saldo * (7 - (a.mesesdc - b.mesesdc))) / sum(7 - (a.mesesdc - b.mesesdc)) as avg_pnd_mas_bal_06m,
...
select
  ...
  sum(b.saldo * (1 + (a.mesesdc - b.mesesdc))) / sum(1 + (a.mesesdc - b.mesesdc)) as avg_pnd_menos_bal_12m,
  sum(b.saldo * (13 - (a.mesesdc - b.mesesdc))) / sum(13 - (a.mesesdc - b.mesesdc))  as avg_pnd_mas_bal_12m,
