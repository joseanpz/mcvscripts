...
---------------------
DROP TABLE IF EXISTS 
    DBMYMWORK.JEA_MCV_VARIABLES_201901;

CREATE TABLE IF NOT EXISTS
    DBMYMWORK.JEA_MCV_VARIABLES_201901 AS
SELECT DISTINCT
	B.RFC,
	B.LLAVE_UNIVERSAL_20,
	B.FECHA,
...
LEFT JOIN  LGG_MCV_VAR_MODELO A
...
CREATE INDEX UNIVERSO_WDW_RFC_IDX
ON DBMYMWORK.JEA_MCV_VARIABLES_201901 (RFC);

CREATE INDEX UNIVERSO_WDW_FECHA_IDX
ON DBMYMWORK.JEA_MCV_VARIABLES_201901 (FECHA);

CREATE INDEX UNIVERSO_WDW_LLAVE_UNIVERSAL_IDX
ON DBMYMWORK.JEA_MCV_VARIABLES_201901 (LLAVE_UNIVERSAL_20);

CREATE UNIQUE INDEX UNIVERSO_WDW_LLAVE_UNIVERSAL_FECHA_IDX
ON DBMYMWORK.JEA_MCV_VARIABLES_201901 (LLAVE_UNIVERSAL_20, FECHA);