...
DROP TABLE IF EXISTS JEA_MCV_CRED_LIM ; -- CURRENT LINE AMOUNT

CREATE TABLE IF NOT EXISTS JEA_MCV_CRED_LIM AS 
SELECT 
...
ALTER TABLE JEA_MCV_CRED_LIM ADD INDEX LLAVE(RFC);
ALTER TABLE JEA_MCV_CRED_LIM ADD INDEX LLAVE1(CLIENTE);
ALTER TABLE JEA_MCV_CRED_LIM ADD INDEX LLAVE2(LINEA);
ALTER TABLE JEA_MCV_CRED_LIM ADD INDEX LLAVE3(LLAVE_UNIVERSAL_20);
