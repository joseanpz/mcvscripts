...
DROP TABLE IF EXISTS DBMYMWORK.JAT_MCV_CASTIGOS;

CREATE TABLE IF NOT EXISTS
	DBMYMWORK.JAT_MCV_CASTIGOS AS
SELECT
	LPAD(CONCAT(LINEA,MONEDA),25,'0') AS LLAVE_UNIVERSAL,
	MIN(ANIOMES) AS FECHA_CASTIGO
FROM
	DBRSKDATAMART.Tbl_Castigos
WHERE
...
SELECT @FECHA_MAX:=(SELECT MAX(FECHA) FROM DBMYMWORK.JAT_BKT_CARTERA_CREDITICIA_201201_201804);

DROP TABLE IF EXISTS DBMYMWORK.JAT_MCV_NEGOCIOS_CONTEO_ROLL_RATE;
